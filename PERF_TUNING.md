...
```
# SOURCE: https://github.com/iovisor/bcc/issues/1878
...
SOURCE: https://github.com/zoidbergwill/awesome-ebpf
...
# Custom compile kernel ( need to do this )
...
sudo apt-get install kernel-wedge -y
# some of these may have already been installed, and some may not even be needed.
sudo apt install bison flex libelf-dev fakeroot build-essential crash kexec-tools makedumpfile kernel-wedge libncurses5 libncurses5-dev libelf-dev asciidoc binutils-dev libudev-dev pciutils-dev -y
sudo apt-get install pkg-config-dbgsym -y
...
This takes the current configuration for eac
```


# Default bionic kernel config

```
#
# Automatically generated file; DO NOT EDIT.
# Linux/x86 4.15.0-45-generic Kernel Configuration
#
CONFIG_64BIT=y
CONFIG_X86_64=y
CONFIG_X86=y
...
CONFIG_VERSION_SIGNATURE="Ubuntu 4.15.0-45.48-generic 4.15.18"
CONFIG_SWAP=y
CONFIG_SYSVIPC=y
