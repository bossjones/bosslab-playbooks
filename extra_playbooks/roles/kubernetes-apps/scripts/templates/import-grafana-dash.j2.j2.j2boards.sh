...
# source: https://github.com/bvis/docker-grafana/blob/master/rootfs/initgrafana.d/import-dashboards.sh
...
export GRAFANA_IP="grafana.${DNS_DOMAIN}"
export URL_BASE="http://${GRAFANA_IP}/api/dashboards/db"

curl \
-X POST "${URL_BASE}" -H 'Content-Type: application/json;charset=UTF-8' \
-d @$(pwd)/scripts/fixtures/grafana_dashboards/ingress-nginx.json \
