# sysctl -a ( vagrant, before perf tuning )

```
root@rsyslogd-worker-01:~# sysctl -a
abi.vsyscall32 = 1
...
fs.dentry-state = 34857 19296   45      0       0       0
fs.dir-notify-enable = 1
fs.epoll.max_user_watches = 415600
fs.file-max = 202194
fs.file-nr = 2656       0       202194
fs.inode-nr = 33241     1248
fs.inode-state = 33241  1248    0       0       0       0       0
...
kernel.hostname = rsyslogd-worker-01
kernel.hotplug =
...
kernel.random.boot_id = 16b0a20d-130f-4337-9803-761adaa82226
kernel.random.entropy_avail = 1063
kernel.random.poolsize = 4096
kernel.random.read_wakeup_threshold = 64
kernel.random.urandom_min_reseed_secs = 60
kernel.random.uuid = bd28f188-650b-4226-8700-7b6eccf474d1
...
kernel.sched_domain.cpu0.domain0.max_newidle_lb_cost = 405324
...
kernel.sched_domain.cpu1.domain0.max_newidle_lb_cost = 841976
...
kernel.version = #165-Ubuntu SMP Wed Oct 24 10:58:50 UTC 2018
kernel.watchdog = 1
...
net.ipv4.conf.enp0s8.accept_local = 0
net.ipv4.conf.enp0s8.accept_redirects = 1
net.ipv4.conf.enp0s8.accept_source_route = 1
net.ipv4.conf.enp0s8.arp_accept = 0
net.ipv4.conf.enp0s8.arp_announce = 0
net.ipv4.conf.enp0s8.arp_filter = 0
net.ipv4.conf.enp0s8.arp_ignore = 0
net.ipv4.conf.enp0s8.arp_notify = 0
net.ipv4.conf.enp0s8.bootp_relay = 0
net.ipv4.conf.enp0s8.disable_policy = 0
net.ipv4.conf.enp0s8.disable_xfrm = 0
net.ipv4.conf.enp0s8.force_igmp_version = 0
net.ipv4.conf.enp0s8.forwarding = 0
net.ipv4.conf.enp0s8.igmpv2_unsolicited_report_interval = 10000
net.ipv4.conf.enp0s8.igmpv3_unsolicited_report_interval = 1000
net.ipv4.conf.enp0s8.ignore_routes_with_linkdown = 0
net.ipv4.conf.enp0s8.log_martians = 0
net.ipv4.conf.enp0s8.mc_forwarding = 0
net.ipv4.conf.enp0s8.medium_id = 0
net.ipv4.conf.enp0s8.promote_secondaries = 0
net.ipv4.conf.enp0s8.proxy_arp = 0
net.ipv4.conf.enp0s8.proxy_arp_pvlan = 0
net.ipv4.conf.enp0s8.route_localnet = 0
net.ipv4.conf.enp0s8.rp_filter = 1
net.ipv4.conf.enp0s8.secure_redirects = 1
net.ipv4.conf.enp0s8.send_redirects = 1
net.ipv4.conf.enp0s8.shared_media = 1
net.ipv4.conf.enp0s8.src_valid_mark = 0
net.ipv4.conf.enp0s8.tag = 0
...
net.ipv4.neigh.enp0s8.anycast_delay = 100
net.ipv4.neigh.enp0s8.app_solicit = 0
net.ipv4.neigh.enp0s8.base_reachable_time_ms = 30000
net.ipv4.neigh.enp0s8.delay_first_probe_time = 5
net.ipv4.neigh.enp0s8.gc_stale_time = 60
net.ipv4.neigh.enp0s8.locktime = 100
net.ipv4.neigh.enp0s8.mcast_resolicit = 0
net.ipv4.neigh.enp0s8.mcast_solicit = 3
net.ipv4.neigh.enp0s8.proxy_delay = 80
net.ipv4.neigh.enp0s8.proxy_qlen = 64
net.ipv4.neigh.enp0s8.retrans_time_ms = 1000
net.ipv4.neigh.enp0s8.ucast_solicit = 3
net.ipv4.neigh.enp0s8.unres_qlen = 31
net.ipv4.neigh.enp0s8.unres_qlen_bytes = 65536
...
net.ipv4.tcp_mem = 22989        30652   45978
...
net.ipv4.udp_mem = 45978        61305   91956
...
net.ipv6.conf.enp0s8.router_solicitations = 3
...
net.ipv6.neigh.enp0s8.unres_qlen = 31
net.ipv6.neigh.enp0s8.unres_qlen_bytes = 65536
...
vm.stat_interval = 1
vm.swappiness = 60
vm.user_reserve_kbytes = 63186
vm.vfs_cache_pressure = 100
vm.zone_reclaim_mode = 0
root@rsyslogd-worker-01:~#
```

# sysctl -a ( vagrant, after perf tuning )
...
fs.aio-nr = 0
fs.binfmt_misc.status = enabled
fs.dentry-state = 51906 36039   45      0       0       0
fs.dir-notify-enable = 1
fs.epoll.max_user_watches = 415600
fs.file-max = 1048576
fs.file-nr = 2688       0       1048576
fs.inode-nr = 41078     487
fs.inode-state = 41078  487     0       0       0       0       0
fs.inotify.max_queued_events = 16384
fs.inotify.max_user_instances = 1024
fs.inotify.max_user_watches = 8192
fs.lease-break-time = 45
...
kernel.pty.reserve = 1024
kernel.random.boot_id = 16b0a20d-130f-4337-9803-761adaa82226
kernel.random.entropy_avail = 985
kernel.random.poolsize = 4096
kernel.random.read_wakeup_threshold = 64
kernel.random.urandom_min_reseed_secs = 60
kernel.random.uuid = e3943a4e-1f3c-4bb4-8e59-2f58bf177402
kernel.random.write_wakeup_threshold = 896
kernel.randomize_va_space = 2
kernel.real-root-dev = 0
kernel.sched_autogroup_enabled = 1
...
kernel.sched_domain.cpu0.domain0.imbalance_pct = 125
kernel.sched_domain.cpu0.domain0.max_interval = 4
kernel.sched_domain.cpu0.domain0.max_newidle_lb_cost = 1600374
kernel.sched_domain.cpu0.domain0.min_interval = 2
kernel.sched_domain.cpu0.domain0.name = DIE
kernel.sched_domain.cpu0.domain0.newidle_idx = 0
kernel.sched_domain.cpu0.domain0.wake_idx = 0
...
kernel.sched_domain.cpu1.domain0.imbalance_pct = 125
kernel.sched_domain.cpu1.domain0.max_interval = 4
kernel.sched_domain.cpu1.domain0.max_newidle_lb_cost = 1896926
kernel.sched_domain.cpu1.domain0.min_interval = 2
kernel.sched_domain.cpu1.domain0.name = DIE
kernel.sched_domain.cpu1.domain0.newidle_idx = 0
kernel.sched_domain.cpu1.domain0.wake_idx = 0
